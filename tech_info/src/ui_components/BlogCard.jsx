...
const BlogCard = ({blog}) => {
  return (
    <div className="px-3 py-3 rounded-md w-75 h-auto flex flex-col gap-4 dark:border-gray-800 border shadow-lg">
      <Link to={`/blogs/${blog.slug}`}>
      <div className="w-full h-50 border rounded-md overflow-hidden">
        <img
